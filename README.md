...
## December 14th, 2025
The coin sprite was enhanced with refined 3D edge lines and new particle effects. Player and enemy animations were updated for increased fluidity. Enemy prefabs were remade to alter colors and sizes, categorizing them as passive (spikes, satellites) and reactive (slimes). And the level design are remade with new environments, items, and enemy placements.
